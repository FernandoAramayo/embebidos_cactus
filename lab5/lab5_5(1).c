...
void setup_timer() {
    ...
    // Set load value
    TimerLoadSet(TIMER0_BASE, TIMER_A, g_ui32SysClock*0.5);
...
void Timer0IntHandler(void)
{
    ...
    ADCSequenceDataGet(ADC0_BASE, 3, potValue);
    intensity = ((potValue[0] * 5999) / 4095) + 1;
    
    PWMPulseWidthSet(PWM0_BASE, PWM_OUT_7, intensity);   
}
